...
use App\Http\Controllers\admin\CareerRequestController;
...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::get('category/change_section', [CategoryController::class, 'change_section'])
            ->name('category.change_section');
    });
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::post('attributes/change_show_in_list_status', [AttributeController::class, 'change_show_in_list_status'])
            ->name('attributes.change_show_in_list_status');
    });
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::post('products/save', [ProductController::class, 'store'])
            ->name('products.save');
            Route::get('products/bulk_add', [ProductController::class, 'bulk_create'])
            ->name('products.bulk_add');
            Route::post('products/bulk_save', [ProductController::class, 'bulk_save'])
            ->name('products.bulk_save');
    ...
    Route::middleware('auth')->group(function () {
        Route::get('slider', [SliderControler::class, 'index'])
            ->name('slider');
        Route::get('slider/get_type_data', [SliderControler::class, 'get_type_data'])
            ->name('slider.get_type_data');
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::get('catalogue/change_section', [CatalogueController::class, 'change_section'])
            ->name('catalogue.change_section');
    });
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::get('pages/add', [PagesControler::class, 'create'])
            ->name('pages.add');
        Route::get('menus', [PagesControler::class, 'menus'])
            ->name('menus');
        Route::get('menus/update', [PagesControler::class, 'menus_update'])
            ->name('menus.update');
    ...
    Route::middleware('auth')->group(function () {
        Route::get('dealer', [DealerController::class, 'index'])
            ->name('dealer');
        Route::get('dealer/add', [DealerController::class, 'create'])
            ->name('dealer.add');
        Route::post('dealer/save', [DealerController::class, 'store'])
            ->name('dealer.save');
        Route::get('dealer/edit/{id}', [DealerController::class, 'edit'])
            ->name('dealer.edit');
        Route::patch('dealer/update', [DealerController::class, 'update'])
            ->name('dealer.update');
        Route::post('dealer/destroy/{id}', [DealerController::class, 'destroy'])
            ->name('dealer.destroy');
    });
    Route::middleware('auth')->group(function () {
        Route::get('site_settings', [GeneralSettingsController::class, 'index'])
            ->name('site_settings');
        Route::post('site_settings/store', [GeneralSettingsController::class, 'store'])
            ->name('site_settings.store');
        Route::get('address/{id?}', [GeneralSettingsController::class, 'create'])
            ->name('address.create');
        Route::post('address/upsert', [GeneralSettingsController::class, 'upsert'])
            ->name('address.upsert');
        Route::get('address/destroy/{id}', [GeneralSettingsController::class, 'destroy'])
            ->name('address.destroy');
        Route::get('address/change_main_address/{id}', [GeneralSettingsController::class, 'change_main_address'])
            ->name('address.change_main_address');
    });

    Route::middleware('auth')->group(function () {
        Route::get('gallery/list', [GalleryController::class, 'index'])
            ->name('gallery');
        Route::get('gallery/{id?}', [GalleryController::class, 'create'])
            ->name('gallery.create');
        Route::post('gallery/upsert', [GalleryController::class, 'store'])
            ->name('gallery.upsert');
        Route::post('gallery/destroy/{id}', [GalleryController::class, 'destroy'])
    ...
    Route::middleware('auth')->group(function () {
        Route::get('career', [CareerController::class, 'index'])
            ->name('career');
        Route::get('career/add', [CareerController::class, 'create'])
            ->name('career.add');
        Route::post('career/save', [CareerController::class, 'store'])
            ->name('career.save');
        Route::get('career/edit/{id}', [CareerController::class, 'edit'])
            ->name('career.edit');
        Route::patch('career/update', [CareerController::class, 'update'])
            ->name('career.update');
        Route::post('career/destroy/{id}', [CareerController::class, 'destroy'])
            ->name('career.destroy');
        Route::post('career/change_status/{id}', [CareerController::class, 'change_status'])
            ->name('career.change_status');
    });
    Route::middleware('auth')->group(function () {
        Route::get('career_request', [CareerRequestController::class, 'index'])
            ->name('career_request');
        Route::get('career_request/add', [CareerRequestController::class, 'create'])
            ->name('career_request.add');
        Route::get('career_request/show/{id}', [CareerRequestController::class, 'show'])
            ->name('career_request.show');
        Route::post('career_request/save', [CareerRequestController::class, 'store'])
            ->name('career_request.save');
        Route::get('career_request/edit/{id}', [CareerRequestController::class, 'edit'])
            ->name('career_request.edit');
        Route::patch('career_request/update', [CareerRequestController::class, 'update'])
            ->name('career_request.update');
        Route::post('career_request/destroy/{id}', [CareerRequestController::class, 'destroy'])
            ->name('career_request.destroy');
    });
});
...
Route::middleware('auth')->group(function () {
    ...
    // uploaded files
    Route::any('/uploaded-files/file-info', [FileUploadController::class, 'file_info'])->name('uploaded-files.info');
    Route::resource('/uploaded-files', FileUploadController::class)->except('destroy');
    Route::get('/uploaded-files/destroy/{id}', [FileUploadController::class, 'destroy'])->name('uploaded-files.destroy');
});
Route::post('states_by_country_id', [LocationController::class, 'states_by_country_id'])
    ->name('states_by_country_id');
Route::post('cities_by_state_id', [LocationController::class, 'cities_by_state_id'])
    ->name('cities_by_state_id');
