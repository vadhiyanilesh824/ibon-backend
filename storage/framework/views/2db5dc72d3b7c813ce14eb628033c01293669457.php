...
<?php $__env->startSection('content'); ?>
    ...
    <section class="top-space-margin page-title-big-typography cover-background magic-cursor round-cursor"
        style="background-image: url(<?php echo e($data['image']); ?>)">
        <div class="container">
            <div class="row extra-very-small-screen pt-10 md-pt-20">
                <div class="col-12 position-relative page-title-extra-small"
                    ...
                    <h1 class="mb-20px xs-mb-20px text-white text-shadow-medium"><span
                            class="w-30px h-2px bg-yellow d-inline-block align-middle position-relative top-minus-2px me-10px"></span><?php echo e($data['subtitle']); ?>

                    </h1>
                    <h2 class="text-white text-shadow-medium fw-500 ls-minus-2px mb-0"><?php echo e($data['title']); ?></h2>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg">
                    <div class="row justify-content-center mb-3">
                        <div class="col-lg-6 col-md-7 col-sm-8 text-center"
                            ...
                            <h4 class="fw-700 text-dark-gray ls-minus-2px"><?php echo e($data['title']); ?></h4>
                        </div>
                    </div>
                    <div class="row mb-5">
                        <?php $__currentLoopData = $main_parentcategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mpc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-4 mb-30px ">
                                <div class="position-relative overflow-hidden"
                                    data-anime='{ "effect": "slide", "color": "#005153", "direction":"lr", "easing": "easeOutQuad", "delay":50}'>
                                    <a href="<?php echo e(route('site.category',$mpc->slug)); ?>">
                                        <img src="<?php echo e($mpc->banner_url); ?>" alt=""
                                        ...
                                        <div class="bg-very-light-gray position-absolute pt-15px pb-15px ps-15px pe-15px border-radius-4px bottom-20px right-20px left-20px box-shadow-large d-flex align-items-center"
                                            ...
                                            <span class="text-dark-gray ls-1px d-inline-block lh-22"><?php echo e($mpc->name); ?></span>
                                        </div>
                                </div>
                                </a>
                            </div>
    ...
    <section>
        ...
        <!-- <div class="container-fluid p-0">
                    <img src="<?php echo e(asset('assets/images/image/about-7.jpg')); ?>" class="mt-30px md-mt-15px mb-60px md-mb-40px border-radius-0px w-100"
                        alt="">
                </div> -->
...
<?php echo $__env->make('fontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\ibon-backend\resources\views/fontend/pages/category.blade.php ENDPATH**/ ?>