...
<?php $component = App\View\Components\AdminLayout::resolve(['pageTitle' => ''.e(__('Blog Category')).'','pageDescription' => ''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <a href="<?php echo e(route('blog-category.add')); ?>" class="btn btn-primary btn-xs float-right"><?php echo e(__("Add")); ?></a>
                            ...
                            <td>
                              ...
                              <div class="btn-group">
                                ...
                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                    ...
                                    <li>
                                      <a href="<?php echo e(route('blog-category.edit', $data->id)); ?>" class="btn btn-link"><i class="dripicons-document-edit"></i> <?php echo e(__('Edit')); ?></a>
                                    </li>
                                    
                                    <li class="divider"></li>
                                    <form method="POST" action="<?php echo e(route('blog-category.destroy', $data->id)); ?>">
                                      <?php echo csrf_field(); ?>
                                    <li>
...
<?php endif; ?>
<?php /**PATH E:\xampp\htdocs\ibon-backend\resources\views/backend/blog_system/category/index.blade.php ENDPATH**/ ?>