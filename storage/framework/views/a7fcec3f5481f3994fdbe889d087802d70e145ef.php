...
<?php $component->withAttributes([]); ?>
    <div class="login-box">
        <div class="login-logo">
            <a href="<?php echo e(route('site.home')); ?>"><b>DS</b> INFOWAY</a>
        </div>
        <!-- /.login-logo -->
        <div class="card">
...
<?php $component = App\View\Components\Alert::resolve(['type' => 'alert','message' => $errors] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>">
                    ...
                    <div class="input-group mb-3">
                        <input id="email" class="form-control" type="email"
                            placeholder="<?php echo e(__('Email / UserName')); ?>" name="email" :value="old('email')" required
                            autofocus />
...
<?php endif; ?>
<?php /**PATH E:\xampp\htdocs\ibon-backend\resources\views/auth/login.blade.php ENDPATH**/ ?>