...
<?php $__env->startSection('content'); ?>
    ...
    <section class="top-space-margin page-title-big-typography cover-background magic-cursor round-cursor"
        style="background-image: url(<?php echo e(asset('assets/images/image/information-1.png')); ?>)">
        <div class="container">
        ...
        <div class="container">
            <div class="row row-cols-1 row-cols-lg-3 row-cols-sm-2 justify-content-center " data-aos="fade-up"
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="feature-box p-8 overflow-hidden">
                        <div class="feature-box-icon">
                            <img src="<?php echo e(asset('assets/images/applications/hm-use-02.png')); ?>" class="h-60px xs-h-60px"
                                alt="" />
                        </div>
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="feature-box p-8 overflow-hidden">
                        <div class="feature-box-icon">
                            <img src="<?php echo e(asset('assets/images/applications/hm-use-01.png')); ?>" class="h-60px xs-h-50px"
                                alt="" />
                        </div>
                        <div class="feature-box-content last-paragraph-no-margin">
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="feature-box p-8 overflow-hidden">
                        <div class="feature-box-icon">
                            <img src="<?php echo e(asset('assets/images/applications/hm-use-03.png')); ?>" class="h-60px xs-h-50px"
                                alt="" />
                        </div>
                        <div class="feature-box-content last-paragraph-no-margin">
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="feature-box p-8 overflow-hidden">
                        <div class="feature-box-icon">
                            <img src="<?php echo e(asset('assets/images/applications/hm-use-04.png')); ?>" class="h-60px xs-h-50px"
                                alt="" />
                        </div>
                        <div class="feature-box-content last-paragraph-no-margin">
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="feature-box p-8 overflow-hidden">
                        <div class="feature-box-icon">
                            <img src="<?php echo e(asset('assets/images/applications/hm-use-05.png')); ?>" class="h-60px xs-h-50px"
                                alt="" />
                        </div>
                        <div class="feature-box-content last-paragraph-no-margin">
                ...
                <div class="col-md-4 col-sm-12 ">
                    <div class="feature-box p-8 overflow-hidden">
                        <div class="feature-box-icon">
                            <img src="<?php echo e(asset('assets/images/applications/hm-use-06.png')); ?>" class="h-60px xs-h-50px"
                                alt="" />
                        </div>
                        <div class="feature-box-content last-paragraph-no-margin">
    ...
    <section class="pb-0">
        <div class="container-fluid p-0">
            <video src="<?php echo e(asset('assets/video/information-1.mp4')); ?>" autoplay loop muted class="border-radius-0px"></video>
        </div>
    </section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('fontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\ibon-backend\resources\views/fontend/pages/product_information.blade.php ENDPATH**/ ?>