...
<?php $__env->startSection('content'); ?>
    ...
    <section class="top-space-margin page-title-big-typography cover-background magic-cursor round-cursor" id="small"
        style="background-image: url(<?php echo e(asset('assets/images/image/catalogue-2.png')); ?>);">
        <div class="container">
    ...
    <!-- end page title -->
    <?php $__currentLoopData = \App\Models\Category::where('parent_id', 0)->orderByDesc('id')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $main_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
                    ...
                    <div class="row justify-content-center row-a mb-5 appear " data-aoss="slide-up" data-aos-duration="800"
                        ...
                        <div class="col-xl-5 col-md-7 col-lg-6 col-sm-8 text-center appear">
                            <h3 class="text-dark-gray fw-700 ls-minus-1px" data-aoss="slide-up"data-aos-duration="800"
                                data-aos-delay="0"><?php echo e($main_category->name); ?></h3>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 text-center tab-style-08">
                            <ul
                                ...
                                <li class="nav active"><a class="portfolio_all_click fs-20 pb-5px" data-filter=".cat<?php echo e($main_category->id); ?>" href="#">All</a>
                                </li>
                                <?php $__currentLoopData = $main_category->categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        $cat_id = '-' . $category->id . '-';
                                    ?>
                                    <?php if(
                                        ...
                                        <li class="nav"><a class="fs-20 pb-5px" data-filter=".cat<?php echo e($category->id); ?>"
                                                href="#"><?php echo e($category->name); ?></a></li>
                                    <?php endif; ?>
                        ...
                        <div class="col-12 filter-content">
                            <ul
                                ...
                                <?php if(
                                    ...
                                    <?php $__currentLoopData = $catalogue->filter(function ($f) use ($cat_id) {
            return strpos($f->cat_ids, $cat_id) !== false ? 1 : 0;
        }); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ctlg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                            $cat_classes = str_replace('-', ' cat', $ctlg->cat_ids);
                                        ?>
                                        <li
                                            class="grid-item cat<?php echo e($main_category->id); ?> <?php echo e($cat_classes); ?> transition-inner-all">
                                            <div class="col text-center team-style-01 mb-30px">
                                                <figure class="mb-0 hover-box box-hover position-relative"
                                                    ...
                                                    <img src="<?php echo e(\App\Services\Helpers::uploaded_asset($ctlg->image)); ?>"
                                                        alt="" class="border-radius-6px appear anime-complete"
                                                        style="aspect-ratio:3/2;object-fit:cover">

                                                    <figcaption class="w-100 p-10px lg-p-25px bg-white">
                                                        <a href="<?php echo e($ctlg->pdf != null ? \App\Services\Helpers::uploaded_asset($ctlg->pdf) : $ctlg->pdf_url); ?>"
                                                        ...
                                                        <div
                                                            ...
                                                            <span
                                                                class="fs-19 d-block fw-600 text-dark-gray lh-26 ls-minus-05px"><?php echo e($ctlg->title); ?></span>
                                                            <?php echo $ctlg->category->id == $ctlg->main_category->id
                                                                ? $ctlg->category->name
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('fontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\ibon-backend\resources\views/fontend/pages/catalogue.blade.php ENDPATH**/ ?>