...
<?php $__env->startSection('content'); ?>
    ...
    <section class="top-space-margin page-title-big-typography cover-background magic-cursor round-cursor" id="small"
        style="background-image: url(<?php echo e(asset('assets/images/image/export-6.png')); ?>);">
        <div class="container">
        ...
        <div class="row align-items-center justify-content-center mb-7">
            ...
            <div class="col-lg-6 text-center md-mb-20px offset-xl-1">
                <figure class="position-relative mb-0 overflow-hidden shadow-in skrollable skrollable-between"
                    ...
                    <img src="<?php echo e(asset('assets/images/image/export-5.png')); ?>" class="w-150 h-400 border-radius-6px" alt=""
                        data-no-retina="">
                </figure>
            </div>
        </div>
        ...
        <div class="container pt-5 pb-5">
            <div class="row "data-aos="fade-up" data-aos-duration="800">
                <div class="col-xl-12 col-md-12 text-center">
                    <img src="<?php echo e(asset('assets/images/image/map-3.png')); ?>" id="export-map" alt="">
                    <img src="<?php echo e(asset('assets/images/image/Group 164.png')); ?>" class="mt-2" alt="" width="700">
                </div>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('fontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\ibon-backend\resources\views/fontend/pages/export.blade.php ENDPATH**/ ?>