		...
		<div class="modal-content h-100">
			<div class="modal-header pb-0 bg-light">
				<div class="uppy-modal-nav">
					<ul class="nav nav-tabs border-0">
						<li class="nav-item">
							<a class="nav-link active font-weight-medium text-dark" data-toggle="tab" href="#dsj-select-file">{{  __('Select File') }}</a>
						</li>
						<li class="nav-item">
							<a class="nav-link font-weight-medium text-dark" data-toggle="tab" href="#dsj-upload-new">{{  __('Upload New') }}</a>
						</li>
					</ul>
				</div>
							...
							<div class="row align-items-center gutters-5 gutters-md-10 position-relative">
								...
								<div class="col-md-4 col-xl-3 ml-auto mr-0 col-2 position-static">
									<div class="dsj-uploader-search text-right">
										<input type="text" class="form-control form-control-xs" name="dsj-uploader-search" placeholder="{{  __('Search your files') }}">
			...
			<div class="modal-footer justify-content-between bg-light">
				<div class="flex-grow-1 overflow-hidden d-flex">
					<div class="">
						<div class="dsj-uploader-selected">{{  __('0 File selected') }}</div>
						<button type="button" class="btn-link btn btn-sm p-0 dsj-uploader-selected-clear">{{  __('Clear') }}</button>
					</div>
					<div class="mb-0 ml-3">
				...
				<button type="button" class="btn btn-sm btn-primary" data-toggle="dsjUploaderAddSelected">{{  __('Add Files') }}</button>
			</div>
		</div>
	</div>
</div>
