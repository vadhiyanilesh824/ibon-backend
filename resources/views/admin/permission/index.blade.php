...
<x-admin-layout page-title="{{ __('Permission') }}" page-description="">
    @section('breadcrumb')
        <x-breadcrumb :breadcrumbs="@[['title'=>__('Permission'), 'url' => '#' ]]" ></x-breadcrumb>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <a href="{{ route('permission.add') }}" class="btn btn-primary btn-xs float-right">{{ __("Add") }}</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                        <li>
                                          <a href="{{ route('permission.edit', $data->id) }}" class="btn btn-link"><i class="dripicons-document-edit"></i> {{ __('Edit')}}</a>
                                        </li>
                                        <li class="divider"></li>
