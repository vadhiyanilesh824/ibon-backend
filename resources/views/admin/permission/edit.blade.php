    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-default">
              ...
              <!-- form start -->
              <form id="quickForm" method="POST" action="{{ route('permission.update') }}">
                @csrf
                <input type="hidden" name="id" value="{{ Crypt::encryptString($permission->id) }}" />
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputEmail1">{{ __("Permission Name") }}</label>
                        <input type="text" name="permission" value="{{ $permission->name }}" class="form-control" id="exampleInputName1" placeholder="{{ __("Permission Name") }}">
                      </div>
