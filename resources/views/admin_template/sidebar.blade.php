...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{url('/admin')}}" class="brand-link">
      <img src="{{ site_settings('logo',true) }}" alt="{{ site_settings('company_name',true) }}" class="brand-image elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">{{ site_settings('company_name',true) }}</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          {{-- <li class="nav-item">
            <x-sidebar-nav-link :href="route('menus')" :active="request()->routeIs('menus')">
              <i class="nav-icon fas fa-file"></i>
              <p>
                {{ __("Menu") }}
                <i class="right fas fa-angle-right"></i>
          ...
          <li class="nav-item">
            <x-sidebar-nav-link :href="route('uploaded-files.index')" :active="request()->routeIs('uploaded-files.index')">
              <i class="nav-icon fas fa-file"></i>
              <p>
                {{ __("Uploaded Files") }}
                <i class="right fas fa-angle-right"></i>
          ...
          <li class="nav-item">
            <x-sidebar-nav-link :href="route('site_settings')" :active="request()->routeIs('site_settings')">
              <i class="nav-icon fas fa-users"></i>
              <p>
                {{ __("Settings") }}
                <i class="right fas fa-angle-right"></i>
          ...
          <li class="nav-item">
            <x-sidebar-nav-link :href="route('gallery')" :active="request()->routeIs('gallery')">
          ...
          <li class="nav-item {{request()->routeIs('career.*')?'menu-open':''}} {{request()->routeIs('career')?'menu-open':''}} {{request()->routeIs('career_request.*')?'menu-open':''}} {{request()->routeIs('career_request')?'menu-open':''}}">
            <x-sidebar-nav-link :active="(request()->routeIs('career.*') || request()->routeIs('career_request.*'))">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <x-sidebar-nav-link :href="route('career')" :active="request()->routeIs('career')" >
                  <i class="far fa-circle nav-icon"></i>
                  <p>{{ __("Career Posts") }}</p>
                </x-sidebar-nav-link>
              </li>
              <li class="nav-item">
                <x-sidebar-nav-link :href="route('career_request')" :active="request()->routeIs('career_request')" >
                  <i class="far fa-circle nav-icon"></i>
                  <p>{{ __("Career Request") }}</p>
                </x-sidebar-nav-link>
              </li>
            </ul>
          </li>
