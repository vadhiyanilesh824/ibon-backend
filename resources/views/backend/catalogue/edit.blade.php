                    ...
                    <form class="p-4" action="{{ route('catalogue.update') }}" method="POST"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" placeholder="{{ __('title') }}" name="title"
                                value="{{ $catalogue->title }}" class="form-control" required>
                        </div>
                        <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group" data-toggle="dsjuploader" data-type="document">
                                ...
                                <div class="form-control file-amount">{{ __('Choose File') }}</div>
                                <input type="hidden" name="pdf" value="{{ $catalogue->pdf }}"
                                    class="selected-files">
                            </div>
                            <div class="file-preview box sm">
                            </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" placeholder="{{ __('Pdf Url') }}" value="{{ $catalogue->pdf_url }}"
                                name="pdf_url" class="form-control">
                        </div>
                            ...
                            <select class="form-control select2" name="category_id" required>
                                ...
                                @foreach ($categories as $category)
                                    ...
                                    @foreach ($category->childrenCategories as $childCategory)
                                        @include('backend.catalogue.child_category', [
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" value="{{ $catalogue->description }}" class="form-control summernote" id="summernote"
                                cols="30" rows="5">{{ $catalogue->description }}</textarea>
                        </div>
