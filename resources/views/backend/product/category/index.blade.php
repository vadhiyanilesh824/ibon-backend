            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  ...
                  {{-- @can("Add User") --}}
                  <a href="{{ route('category.add') }}" class="btn btn-primary btn-xs float-right">{{ __("Add") }}</a>
                  {{-- @endcan --}}
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                            ...
                            <td>
                              ...
                              <div class="btn-group">
                                ...
                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                    {{-- @can("Edit") --}}
                                    <li>
                                      <a href="{{ route('category.edit', $data->id) }}" class="btn btn-link"><i class="dripicons-document-edit"></i> {{ __('Edit')}}</a>
                                    </li>
                                    {{-- @endcan
                                    @can("Delete") --}}
                                    <li class="divider"></li>
