    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    <!-- form start -->
                    <form action="{{ route('career.save') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea name="short_description" rows="3" placeholder="{{ __('Short Description') }}" class="form-control"></textarea>
                        </div>
                        <div class="form-group">
                            <label class="col-from-label">{{ __('Description') }} <span
                                    class="text-danger">*</span></label>
                            <textarea name="long_description" class="form-control summernote" id="summernote" cols="30" rows="5"></textarea>
                        </div>
                        <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input"
                                    name="is_active" id="customSwitch3" checked>
